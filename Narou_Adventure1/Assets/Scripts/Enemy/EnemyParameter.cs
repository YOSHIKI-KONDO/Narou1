...
public class EnemyParameter : BASE {
	...
	void Awake () {
        ...
        parameters.Add(new parameter(EnemyKind.slime,             5, 3.8, 3.1,  3.1,    1,  1,    1,   3));
        parameters.Add(new parameter(EnemyKind.goblin,            3, 4.4, 1.7,  3.9,    1,  1,    1,   4));
        parameters.Add(new parameter(EnemyKind.rat,               2, 4.0, 2.0,  4.0,    1,  1,    1,   7));
        parameters.Add(new parameter(EnemyKind.bird,              4, 3.3, 3.3,  3.3,    1,  1,    1,   5));
        parameters.Add(new parameter(EnemyKind.bat,               5, 3.1, 4.4,  2.5,    1,  1,    1,   8));
        ...
        parameters.Add(new parameter(EnemyKind.red_slime,         2, 3.3, 3.3,  3.3,    1,  1,    2,  11));
