...
public class I_WarriorTextbook : ITEM
{
    ...
    void Awake()
    {
        AwakeItem(ItemKind.warrior_textbook, 1,1,4,1,1);
        ...
        EffectLists.Add(new Dealing(AbilityKind.beginner_bojutsu, Dealing.A_ParaKind.maxLevel, 1));
        EffectLists.Add(new Dealing(AbilityKind.beginner_shieldmanship, Dealing.A_ParaKind.maxLevel, 1));
        EffectLists.Add(new Dealing(AbilityKind.beginner_battleaxe, Dealing.A_ParaKind.maxLevel, 1));
        EffectLists.Add(new Dealing(AbilityKind.beginner_martialart, Dealing.A_ParaKind.maxLevel, 1));
