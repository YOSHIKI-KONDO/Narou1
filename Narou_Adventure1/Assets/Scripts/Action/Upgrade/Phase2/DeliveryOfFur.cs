...
public class DeliveryOfFur : UPGRADE_ACTION
{
    ...
    void Awake () {
        ...
        progress.completeEffectList.Add(new Dealing(ResourceKind.gold, Dealing.R_ParaKind.current, 10));
        progress.completeEffectList.Add(new Item_Dealing(ItemKind.claw_bar));
    }
