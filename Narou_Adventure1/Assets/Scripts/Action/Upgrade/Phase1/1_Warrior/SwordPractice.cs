...
public class SwordPractice : UPGRADE_ACTION
{
    ...
    void Awake () {
        AwakeUpgradeAction(MainAction.ActionEnum.Upgrade.sword_practice, 1,10);
        progress.progressCostList.Add(new Dealing(ResourceKind.action, Dealing.R_ParaKind.current, -0.7));
