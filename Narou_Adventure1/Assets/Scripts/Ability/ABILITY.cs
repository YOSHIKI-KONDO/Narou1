...
public class ABILITY : BASE, INeed, ISetSource
{
    ...
    void ApplyPopUp()
    {
        ...
        if (popUp.gameObject.activeSelf)
        {
            ...
            ChangeTextAdaptive(Unlock_str, popUp.textPros[3], popUp.textPros[2].gameObject, popUp.textPros[3].gameObject);
            ...
            ChangeTextAdaptive(ProgressEffect_str, popUp.textPros[11], popUp.textPros[10].gameObject, popUp.textPros[11].gameObject);
            ChangeTextAdaptive(CompleteEffect_str, popUp.textPros[13], popUp.textPros[12].gameObject, popUp.textPros[13].gameObject);
            ChangeTextAdaptive(UnlockContent_str, popUp.textPros[14], popUp.textPros[14].gameObject);
        }
    }
